---
name: ultrawork-execution-engine
description: Goal-oriented execution loop decomposing complex projects into verifiable, systematic milestones.
---
...
1. Inspect execution tasks.
2. Run deterministic iteration.
