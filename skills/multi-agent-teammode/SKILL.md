---
name: multi-agent-teammode
description: Coordinates teams of cooperating Codex agents with script-managed persistent state.
---
...
1. Initialize isolated execution context.
2. Run targeted capabilities.
3. Produce verifiable structured evidence.
