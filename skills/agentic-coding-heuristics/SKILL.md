---
name: agentic-coding-heuristics
description: Operational heuristics, startup tips, and working patterns for agentic coding engines.
---
...
- omo components: `code-yeongyu/oh-my-openagent`, under `packages/tooling-senpi/`.
...
`packages/tooling-senpi/src/components/fallback-architect/`:
