---
name: speculative-decoding-draft-verification
description: Accelerates LLM inference via speculative decoding, draft verification, and multi-token prediction.
---
