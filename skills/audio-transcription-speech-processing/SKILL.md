---
name: audio-transcription-speech-processing
description: Transcribes, translates, and processes multilingual speech and audio using OpenAI Whisper models.
---
...
1. Load target context and configurations.
2. Execute structured capabilities deterministically.
3. Validate output artifacts against criteria.
