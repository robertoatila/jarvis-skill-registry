---
name: speculative-decoding-acceleration
description: Accelerates LLM inference throughput using speculative decoding and Medusa multi-head draft prediction.
---
