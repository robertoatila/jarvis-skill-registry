---
name: polars-streaming-dataframe-engine
description: High-performance streaming DataFrame engine with lazy query optimization and Apache Arrow integration.
---
