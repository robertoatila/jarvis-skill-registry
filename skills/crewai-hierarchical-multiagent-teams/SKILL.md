---
name: crewai-hierarchical-multiagent-teams
description: Orchestrates autonomous multi-agent teams with role-based collaboration and hierarchical execution.
---
